...
filters:
  - social-share
share:
  permalink: "https://cmmid.github.io/gaza-response/"
  description: "Monitoring the nutritional status of humanitarian workers in Gaza"
  twitter: true
  facebook: true
  reddit: true
  stumble: true
...
## Load summary: cross-sectional timeseries
summary_daily <- readRDS(here("data", "public", "summary-cohort-daily.RDS"))
## Load summary: latest data for all participants
summary_all <- readRDS(here("data", "public", "summary-cohort-all.RDS"))
## Load summary tables
summary_tables <- readRDS(here("data", "public", "summary-tables.RDS"))

# Stratifications
strata <- log$strata
# --- [[ code for 2x stratification ]] ---
...
meta_params <- list("organisation" = names(summary_all))
...
<p> Data: `r log$data_raw$max_date` | Website: `r Sys.Date()`</p>
</details>
