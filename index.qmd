...
### About the project
This project aims to inform humanitarian decision-making, advocacy and diplomatic action to improve the lives of the famine-affected population in Gaza by providing real-time information on the nutritional status of humanitarian staff. The project is implemented with the support of the London School of Hygiene and Tropical Medicine (LSHTM).
...
::: {.callout-caution}
## Caution
This project remains under active development, with data collection and analysis occurring in 
real time in an evolving situation. To get involved, read more about the project in the [About](./about) section.
:::
