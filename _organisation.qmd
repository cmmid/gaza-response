...
```{r, include=FALSE}
strata <- params_meta$strata
data_filtered <- data[[params_meta$organisation]]
...
::: {.callout-note collapse="false" title="Key insights"}
...
::: {.callout-note .current_summary_card .lshtm_widget title="Current summary" collapse = "false"}
...
::: {.callout-note .trend_time_card .lshtm_widget title="Recent trends" collapse="false"}
<!-- Can't set ID or data-widget value in this pandoc-card element, so need another nested div... -->
...
<!-- Create div for trend over time -->
::: {.callout-note .trend_bmi_card .lshtm_widget title="Participants by BMI category" collapse = "false"}
<!-- Can't set ID or data-widget value in this pandoc-card element, so need another nested div... -->
...
::: {.callout-note collapse="false" .lshtm_widget title="Study participation"}
