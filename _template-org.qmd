...
- Data contributed by **`r params$cohort_size` participants**
- Since **October 2023**, median weight change of **`r params$median_change`%** (25-75% range: `r params$lower_change`-`r params$upper_change`%)
:::
